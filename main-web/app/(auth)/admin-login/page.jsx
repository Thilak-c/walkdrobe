...
export default function AdminLogin() {
  ...
  useEffect(() => {
    // Check if already logged in as admin with valid session
    if (adminUser === undefined) return; // Still loading
    if (adminUser && token) {
      // Valid admin session exists, redirect to admin panel
      router.push("/admin");
    }
      ...
      >
        ...
        <div className="text-center space-y-2">
          ...
          <div className="flex justify-center gap-4 text-xs">
            <a href="/admin-reset" className="text-orange-400 hover:text-orange-300 underline">
              Reset Password
            </a>
            <a href="/admin/promote" className="text-blue-400 hover:text-blue-300 underline">
              Promote User
            </a>
