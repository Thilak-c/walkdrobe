...
import { Trash2, Package, Store, RotateCcw, Clock, X, Eye, Code } from "lucide-react";
import toast from "react-hot-toast";

export default function OfflineTrash() {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-6 pt-12 lg:pt-0">
            <div className="flex items-center gap-2 mb-1">
              ...
              <p className="text-emerald-500 text-xs font-medium">OFFLINE SHOP</p>
            </div>
